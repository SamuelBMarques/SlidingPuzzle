...
/*Define o tamanho máximo do texto que pode ser digitado pelo usuário*/
#define tam 60
#define largura 100			//Define o numero de caracteres na horizontal do terminal 
#define tam_menu 40
...
/*Macros para facilitar o uso dos formatos e cores no projeto*/
...
/*Caracteres úteis para a exibição das matrizes*/
...
/* Tipo de variável para armazenar linha e coluna de um certo valor */
typedef struct{
	int l;			//Linha
	int c;			//Coluna
}Coordenada;
